...
func bind(_ control: UIControl, controlEvents: UIControl.Event = .valueChanged, action: @escaping (UIControl) -> Void) {
...
func clear(_ control :UIControl, controlEvents :UIControl.Event) {
...
private class ActionTarget {
    ...
    init(control: UIControl, action: @escaping (UIControl) -> Void, controlEvents: UIControl.Event) {
